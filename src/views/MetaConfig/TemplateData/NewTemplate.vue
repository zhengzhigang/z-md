...
<div class="panel-center">
    <ms-subheader>新建模板</ms-subheader>
    <div class="ms-bread">
    ...
    <div>
        <div class="ms-form-item ms-row template-form-item">
            <div class="ms-col-24">
                ...
                <div class="ms-form-input-inline">
                    <ms-form-multiple-select v-if="baseFields.length" :organization="baseFields" hint="请选择数据指标" :value="superFields" @input="changeSuper" :custom-style="{ width: '500px' }"></ms-form-multiple-select>
                </div>
            </div>
        </div>
                    ...
                    <div class="ms-row ms-form-item">
                        <div class="ms-col-10">
                            ...
                            <div class="ms-form-input-inline" v-else>
                                <ms-form-organization key="startTime" :organization="sTimeSource" v-model="item.startTime"></ms-form-organization>
                            </div>
                        </div>
                        ...
                        <div class="ms-col-10">
                            ...
                            <div class="ms-form-input-inline" v-else="customDate">
                                <ms-form-organization key="endTime" :organization="eTimeSource" v-model="item.endTime"></ms-form-organization>
                            </div>
                        </div>
                    ...
                    <div class="ms-row ms-form-item">
                            ...
                            <div class="ms-form-input-inline">
                                <div class="chips-wrap" v-if="item.localGroup.length">
                                    <span v-for="(subItem, inx) in item.localGroup" @click="deleteChip(item.localGroup, inx)">
                                        <i class="ion-android-cancel chip-wrap-icon_cancel"></i>
                                        <em>{{ subItem.label }}</em>
                                    </span>
                        ...
                        <div class="ms-col-12">
                            ...
                            <div class="ms-form-input-block">
                                <ms-form-organization :organization="aggregationTypes" v-model="item.aggFunc"></ms-form-organization>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="ms-form-item ms-row template-form-item">
            ...
            <div class="ms-row ms-form-item">
                ...
                <div class="ms-form-input-block">
                    <ms-form-multiple-select v-if="globalFields.length" key="global" :organization="globalFields" hint="请选择分组字段" :value="globalGroup" @input="changeGlobal" :custom-style="{ width: '300px' }"></ms-form-multiple-select>
                </div>
            </div>
        </div>
    ...
    <ms-confirm v-model="confirmVisible" title="请输入自定义指标名称" @confirm-success="confirmSubmit">
        <div class="ms-row relationList-box">
            <input style="width: 100%;" type="text" v-model="templateName" placeholder="请输入名称" class="ms-form-input-text">
        </div>
    </ms-confirm>
